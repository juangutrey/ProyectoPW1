<!-- Encabezado de página con enlaces y datos de contacto -->
<!DOCTYPE html>
<html lang="es">
<head>
  ...
  <nav class="red" role="navigation">
    <div class="nav-wrapper container">
      ...
      <ul class="right hide-on-med-and-down">
        ...
        <li><a href="mailto:contacto@gimnasioaragon.com">Contactanos</a></li>
      </ul>

      <!-- Menú de navegación para dispositivos moviles -->
